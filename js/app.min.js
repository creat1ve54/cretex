...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _swiper_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./swiper.min.js */ \"./src/js/swiper.min.js\");\n/* harmony import */ var _swiper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./swiper.js */ \"./src/js/swiper.js\");\n/* harmony import */ var _progress_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./progress.js */ \"./src/js/progress.js\");\n/* harmony import */ var _graph_accordion_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./graph-accordion.js */ \"./src/js/graph-accordion.js\");\n/* harmony import */ var _portfolio_tabs_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./portfolio-tabs.js */ \"./src/js/portfolio-tabs.js\");\n/* harmony import */ var _inputmask_min_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./inputmask.min.js */ \"./src/js/inputmask.min.js\");\n/* harmony import */ var _just_validate_min_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./just-validate.min.js */ \"./src/js/just-validate.min.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n// Реализация бургер-меню\r\n// import { burger } from './burger.js';\r\n\r\n\r\nconst form = document.querySelector('.know-form');\r\nconst telSelector = form.querySelector('input[type=\"tel\"]');\r\nconst inputMask = new Inputmask('+7 (999) 999-99-99');\r\ninputMask.mask(telSelector);\r\n\r\nnew window.JustValidate('.know-form', {\r\n  rules: {\r\n    tel: {\r\n      required: true,\r\n      function: () => {\r\n        const phone = telSelector.inputmask.unmaskedvalue();\r\n        return Number(phone) && phone.length === 10;\r\n      }\r\n    }\r\n  },\r\n  messages: {\r\n    name: {\r\n      required: 'Введите имя',\r\n      minLength: 'Введите 3 и более символов',\r\n      maxLength: 'Запрещено вводить более 15 символов'\r\n    },\r\n    tel: {\r\n      required: 'Введите телефон',\r\n      function: 'Здесь должно быть 10 символов без +7'\r\n    },\r\n    // раскоментировать если используется в форме email\r\n    // email: {\r\n    //   email: 'Введите корректный email',\r\n    //   required: 'Введите email'\r\n    // },\r\n  },\r\n\r\n  submitHandler: function (thisForm) {\r\n    let formData = new FormData(thisForm);\r\n    let xhr = new XMLHttpRequest();\r\n\r\n    xhr.onreadystatechange = function () {\r\n      if (xhr.readyState === 4) {\r\n        if (xhr.status === 200) {\r\n          console.log('Отправлено');\r\n        }\r\n      }\r\n    }\r\n\r\n    xhr.open('POST', 'mail.php', true);\r\n    xhr.send(formData);\r\n\r\n    thisForm.reset();\r\n  }\r\n})\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\n\n//# sourceURL=webpack://gulp/./src/js/app.js?");

/***/ }),

/***/ "./src/js/graph-accordion.js":
/*!***********************************!*\
  !*** ./src/js/graph-accordion.js ***!
  \***********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\nconst accordionContrl = document.querySelector('.accordion__control');\r\nconst accordionCont = document.querySelector('.accordion__content');\r\n\r\n\r\nclass GraphAccordion {\r\n    constructor(selector, options) {\r\n        let defaultOptions = {\r\n            isOpen: () => {},\r\n            isClose: () => {},\r\n            speed: 300\r\n        };\r\n\r\n        this.options = Object.assign(defaultOptions, options);\r\n        this.accordion = document.querySelector(selector);\r\n        if (accordionContrl || accordionCont) {\r\n            this.control = this.accordion.querySelector('.accordion__control');\r\n            this.content = this.accordion.querySelector ('.accordion__content');\r\n        }\r\n        this.event();\r\n        this.start();\r\n    }\r\n\r\n    start() {\r\n        if (this.accordion) {\r\n            if (this.accordion.classList.contains('is-open')) {\r\n                this.open();\r\n            }\r\n        }\r\n    }\r\n\r\n    event() {\r\n        if (this.accordion) {\r\n            this.accordion.addEventListener('click', (e) => {\r\n                this.accordion.classList.toggle('open');\r\n\r\n                if (this.accordion.classList.contains('open')) {\r\n                    this.open();\r\n                } else {\r\n                    this.close();\r\n                }\r\n            });\r\n        }\r\n    }\r\n\r\n    open() {\r\n        this.accordion.style.setProperty('--accordion-time', `${this.options.speed / 1000}s`);\r\n        this.accordion.classList.add('is-open');\r\n        this.control.setAttribute('aria-expanded', true);\r\n        this.content.setAttribute('aria-hidden', false);\r\n        this.content.style.maxHeight = this.content.scrollHeight + 'px';\r\n        this.options.isOpen(this);\r\n    }\r\n\r\n    close() {\r\n        this.accordion.classList.remove('is-open');\r\n        this.control.setAttribute('aria-expanded', false);\r\n        this.content.setAttribute('aria-hidden', true);\r\n        this.content.style.maxHeight = null;\r\n        this.options.isClose(this);\r\n    }\r\n}\r\n\r\n\r\nconst accordion1 = new GraphAccordion('.accordion-1', {\r\n    speed: 700,\r\n});\r\n\r\nconst accordion2 = new GraphAccordion ('.accordion-2', {\r\n    speed: 700\r\n});\n\n//# sourceURL=webpack://gulp/./src/js/graph-accordion.js?");
